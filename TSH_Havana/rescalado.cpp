...
nvibracional=nivelesesenciales/2+1;
  ...
  ///Vuelve a tomar la posicion 4 que corresponde a la posicion donde se encuentra actualmente el sistema
// cout<<" nuevo nv="<<nvibracional<<" factordeescala="<<factordeescala<<"  "<<int(nivelesesenciales/2+1)<<" "<<(nvibracional+factordeescala)<<endl; 
...
cout<<" energia total de partida="<<energiainicial<<" "<<ev[internamente]<<" "<<internamente<<endl;
/////////////////////////////////////////////////////////////////////////////
 FILE *erest;
    erest=fopen("Erest","a+");  
 double ereste;
